-- 创建数据库
create schema mallSystem1 default character set utf8 collate utf8_general_ci;

-- 用户信息表(customer_inf)
drop table if exists mallSystem1.customer_inf0;
CREATE TABLE mallSystem1.customer_inf0 (
customer_inf_id bigint( 50 ) UNSIGNED AUTO_INCREMENT NOT NULL COMMENT '自增主键ID',
customer_id INT( 20 ) UNSIGNED NOT NULL COMMENT 'customer_login表的自增ID',
...
drop table if exists mallSystem1.customer_inf1;
CREATE TABLE mallSystem1.customer_inf1 (
customer_inf_id bigint( 50 ) UNSIGNED AUTO_INCREMENT NOT NULL COMMENT '自增主键ID',
customer_id INT( 20 ) UNSIGNED NOT NULL COMMENT 'customer_login表的自增ID',
customer_name VARCHAR ( 20 ) NOT NULL COMMENT '用户真实姓名',
identity_card_type TINYINT NOT NULL DEFAULT 1 COMMENT '证件类型：1 身份证，2 军官证，3 护照',
...
-- 商品信息表(product_info)
drop table if exists mallSystem1.product_info0;
CREATE TABLE mallSystem1.product_info0 (
...
drop table if exists mallSystem1.product_info1;
CREATE TABLE mallSystem1.product_info1 (
product_id INT UNSIGNED AUTO_INCREMENT NOT NULL COMMENT '商品ID',
product_core CHAR ( 16 ) NOT NULL COMMENT '商品编码',
product_name VARCHAR ( 20 ) NOT NULL COMMENT '商品名称',
bar_code VARCHAR ( 50 ) NOT NULL COMMENT '国条码',
...
-- 订单主表（order_master）
drop table if exists mallSystem1.order_master0;
CREATE TABLE mallSystem1.order_master0 (
...
drop table if exists mallSystem1.order_master1;
CREATE TABLE mallSystem1.order_master1 (
order_id INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '订单ID',
order_sn BIGINT UNSIGNED NOT NULL COMMENT '订单编号 yyyymmddnnnnnnnn',
customer_id INT UNSIGNED NOT NULL COMMENT '下单人ID',
shipping_user VARCHAR ( 10 ) NOT NULL COMMENT '收货人姓名',
...
-- 订单详情表（order_detail）
drop table if exists mallSystem1.order_detail0;
CREATE TABLE mallSystem1.order_detail0 (
...
drop table if exists mallSystem1.order_detail1;
CREATE TABLE mallSystem1.order_detail1 (
order_detail_id INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '订单详情表ID',
order_id INT UNSIGNED NOT NULL COMMENT '订单表ID',
product_id INT UNSIGNED NOT NULL COMMENT '订单商品ID',
product_name VARCHAR ( 50 ) NOT NULL COMMENT '商品名称',
...
drop table if exists mallSystem1.order_detail2;
CREATE TABLE mallSystem1.order_detail2 (
order_detail_id INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '订单详情表ID',
order_id INT UNSIGNED NOT NULL COMMENT '订单表ID',
product_id INT UNSIGNED NOT NULL COMMENT '订单商品ID',
product_name VARCHAR ( 50 ) NOT NULL COMMENT '商品名称',
...
drop table if exists mallSystem1.order_detail3;
CREATE TABLE mallSystem1.order_detail3 (
order_detail_id INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '订单详情表ID',
order_id INT UNSIGNED NOT NULL COMMENT '订单表ID',
product_id INT UNSIGNED NOT NULL COMMENT '订单商品ID',
product_name VARCHAR ( 50 ) NOT NULL COMMENT '商品名称',
...
-- 购物车表（order_cart）
drop table if exists mallSystem1.order_cart0;
CREATE TABLE mallSystem1.order_cart0 (
...
drop table if exists mallSystem1.order_cart1;
CREATE TABLE mallSystem1.order_cart1 (
cart_id INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '购物车ID',
customer_id INT UNSIGNED NOT NULL COMMENT '用户ID',
product_id INT UNSIGNED NOT NULL COMMENT '商品ID',
product_amount INT NOT NULL COMMENT '加入购物车商品数量',
...
drop table if exists mallSystem1.order_cart2;
CREATE TABLE mallSystem1.order_cart2 (
cart_id INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '购物车ID',
customer_id INT UNSIGNED NOT NULL COMMENT '用户ID',
product_id INT UNSIGNED NOT NULL COMMENT '商品ID',
product_amount INT NOT NULL COMMENT '加入购物车商品数量',
...
drop table if exists mallSystem1.order_cart3;
CREATE TABLE mallSystem1.order_cart3 (
cart_id INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '购物车ID',
customer_id INT UNSIGNED NOT NULL COMMENT '用户ID',
product_id INT UNSIGNED NOT NULL COMMENT '商品ID',
product_amount INT NOT NULL COMMENT '加入购物车商品数量',
...
drop table if exists mallSystem1.warehouse_product0;
CREATE TABLE mallSystem1.warehouse_product0 (
...
drop table if exists mallSystem1.warehouse_product1;
CREATE TABLE mallSystem1.warehouse_product1 (
wp_id INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品库存ID',
product_id INT UNSIGNED NOT NULL COMMENT '商品ID',
current_cnt INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '当前商品数量',
lock_cnt INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '当前占用数据',
